...
export default function AdminDashboard(props: Props) {
  ...
  async function deleteUser(userId: number) {
    ...
    console.log("output of delete user ")
    setUserList(prev => ({
      ...prev,
              ...
              <div className="-m-1.5 overflow-x-auto">
                <div className="p-1.5 min-w-full inline-block align-middle">
                  <div className="overflow-hidden">
                    <table id="franchises-table" className="min-w-full divide-y divide-gray-200">
                      <thead id="franchises-header" className="uppercase text-neutral-100 bg-slate-400 border-b-2 border-gray-500">
                        <tr>
                      ...
                      <tfoot id="franchises-tfoot">
                        <tr>
                          ...
                          <td colSpan={4} className="text-end text-sm font-medium">
                            <button id="franchises-back" className="w-12 p-1 text-sm font-semibold rounded-lg border border-transparent bg-white text-grey border-grey m-1 hover:bg-orange-200 disabled:bg-neutral-300 " onClick={() => setFranchisePage(franchisePage - 1)} disabled={franchisePage <= 0}>
                              «
                            </button>
                            <button id="franchises-forward" className="w-12 p-1 text-sm font-semibold rounded-lg border border-transparent bg-white text-grey border-grey m-1 hover:bg-orange-200 disabled:bg-neutral-300" onClick={() => setFranchisePage(franchisePage + 1)} disabled={!franchiseList.more}>
                              »
                            </button>
                          </td>
                        </tr>
              ...
              <div className="p-1.5 min-w-full inline-block align-middle">
                <div className="overflow-hidden">
                  <table id="users-table" className="min-w-full divide-y divide-gray-200">
                    <thead id="users-header" className="uppercase text-neutral-100 bg-slate-400 border-b-2 border-gray-500">
                      <tr>
